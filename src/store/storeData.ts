...
export const DishInfoStore=writable([
  ...
  {dishId:5,dishname:"Egg",price:350,description:"Egg: A classic American egg made with a juicy beef patty, cheese, lettuce, tomato, and condiments, served on a soft bun.", image:"../image/image11.jpg"},
  ...
  {dishId:9,dishname:"Kathiyawadi Thali",price:550,description:"Kathiyawadi Thali: A traditional meal from the Indian state of Gujarat consisting of a variety of vegetarian dishes.", image:"../image/image15.jpg"},
